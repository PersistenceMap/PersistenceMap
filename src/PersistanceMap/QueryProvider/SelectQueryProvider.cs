...
{
    public partial class SelectQueryProvider<T> : ISelectQueryProviderBase<T>, ISelectQueryProvider<T>, IJoinQueryProvider<T>, IWhereQueryProvider<T>, IAfterMapQueryProvider<T>, IQueryProvider
    {
