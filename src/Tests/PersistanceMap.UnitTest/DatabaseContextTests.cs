...
namespace PersistanceMap.UnitTest
{
    ...
    public class DatabaseContextTests
    {
        ...
        public void Setup()
        {
            ...
            compiler.Setup(c => c.Compile<string>(It.IsAny<IQueryPartsMap>())).Returns(new CompiledQuery());
        ...
        public void AddQueryTest()
        {
            ...
            Assert.IsTrue(context.QueryCommandStore.Any());
            Assert.IsTrue(context.QueryCommandStore.First() == query.Object);
        }
        ...
        public void CommitTest()
        {
            ...
            Assert.IsFalse(context.QueryCommandStore.Any());
